...
def posts_get():
    ...
    if title_like:
        ...
        if body_like:
            posts = posts.filter(models.Post.title.contains(title_like) and models.Post.body.contains(body_like))
    if body_like:
...
def post_delete(id):
    ...
    # Delete the post and reload the rest of the posts
...
#PUT endpoint, ability to update edit the title and body of a post
